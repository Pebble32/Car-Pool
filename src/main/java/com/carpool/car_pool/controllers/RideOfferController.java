...
public class RideOfferController {
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<PageResponse<RideOfferResponse>> searchForRideOffers(
            @RequestParam(name = "page", defaultValue = "0", required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
        ...
        return ResponseEntity.ok(rideOfferService.searchForRides(startLocation, endLocation, departureTime, page, size));
    }
}
